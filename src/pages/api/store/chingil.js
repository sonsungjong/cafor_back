export default function handler(req, res){
    console.log('get요청 신길점')

    const result = {
        detail: [
            { product: "아메리카노", count: "5" },
            { product: "카페라떼", count: "5" },
            { product: "카라멜마끼야또", count: "2" },
            { product: "헤이즐럿라떼", count: "2" },
            ...
            { product: "레몬에이드", count: "0" },
            { product: "컵쿠키", count: "0" },
            { product: "쿠키", count: "0" },
            { product: "아이스크림", count: "0" },
            { product: "마카롱", count: "0" },
            { product: "커피콩빵", count: "0" }
        ]
    };
